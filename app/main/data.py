...
@main.route("/trade_finished/data", methods=["POST"])
def trade_finished_data():
    # 定义列名
    # 定义列名
    CONST_COLS = ["#", "content_abbr.status", "log_time", "handle_flag",
                  "content_abbr.page_size", "content_abbr.page_no",
                  "result.trades.length", "content_abbr.start_time", "content_abbr.end_time", "result.message",
                  "result.code"]
    ...
    queryset = mongo_collection.trade_finished.find(query_params).sort(order_params)
